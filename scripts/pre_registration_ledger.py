...
def selftest():
    ...
    # Live known-positive/negative checks: the positive tuple is currently
    # empty. PR-02 (IC-SPX-FastPT25-S2-130PM) was removed by
    # R-2026-08-18-SELFTEST-KNOWN-POSITIVE-PREAUTH. PR-04
    # (QQQ-IC-0DTE-Fortress-NoPT50) was discharged on 2026-08-31 when its first
    # position passed (R-2026-08-18-PR02-DISCHARGE-PR04-REANCHOR); the ledger
    # now carries the discharge annotation and the parser no longer flags it.
    # The INC-01 negative check remains.
