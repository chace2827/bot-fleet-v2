...
- `scripts/build_ledger.py` is declared frozen at sha `3f0a2719a4efc14c6c894527eb10f4b633389e1f9befc8c892383bd59f8d0ec5` in `docs/roster-mechanics-ruling.md` §0 and §2.4, and is enforced by `scripts/check_freeze_hashes.py` on every CI run.
...
- The current roster authority is `data/captures/2026-08-17-r3/01-oa-bots-capture-2026-08-17-195713.txt` (sha256 `8d9c59b71858c97f43357595dd252d5bd4594a8ab20887da5cda120f64ccdf89`) and its derived `data/captures/2026-08-17-r3/02-roster-toggles-44-2026-08-17.tsv`, per R-2026-08-18-MECHANICS-IN-FORCE. The 2026-08-09-s2b capture (`data/captures/2026-08-09-s2b/partB-hands-signatures-and-final-sweep-2026-08-09.txt`, sha `58704c68…`) is superseded as roster authority.
...
5. **`scripts/execution_audit.py` frozen hash.** RESOLVED by this PR. `daily-loop-spec.md` now declares the file frozen at v1.0.0 with sha `fdc43d0dcb7275560069048e62d897f528d9620b5a6be87de7a410fae1851e2d`, which matches the current file sha.
...
| hash | commit | PR | notes |
|---|---|---|---|
| `9ec21da902e23cdbe5f9ea442a60a9d5ff7f8028b386b559d69bb0b3889cc321` | `6b6ea59cf0d5c9d908e43b0135d2d5be88819197` | (no PR) | "Day-0 S2 Steps 0-7: LEDGER_START 2026-08-10 set (n=0 proven), 16 signatures, ride-all-five ruled, 7 GF arms ON; DA-3 report.py line retired" — the hash recorded in §2.1 at the 2026-08-17 signing. |
| `e12c9ef18969dd32183a2c3c06bd1b11c01be3b36471fd51a544c59c94d40c20` | `fd7fa729c48004db57ef9c7358db5e4c17b70e85` | PR #20 | "G-3: run the pipeline against a scratch root, never the live ledger" — the movement 9ec21da9… → e12c9ef1… happened here. |
...
| `3f0a2719a4efc14c6c894527eb10f4b633389e1f9befc8c892383bd59f8d0ec5` | `432d6449a0c504331d3977c2945f6f9e72849d6b` | PR #77 | "T-45: ingest + ledger refuse a range-shortened export" — the movement f2f2f706… → 3f0a2719… happened here, AFTER the T-47 base and before T-47 merged. The `build_ledger.py` change adds the raw-vs-raw coverage-floor REFUSAL (newest export's earliest openDate later than the previous export's post-cutover floor → exit non-zero, nothing written, no override flag) — an input guard, **Class C**, same class as the PR #56 guards; S1–S8 selftests added. Re-recorded 2026-09-08 by the version-bump procedure (§7), at merge of T-47. |
