...
- **The existing local repo (git, ~22 scripts, 8-stage `daily.sh`, ~50 markdown docs) is sound and stays authoritative.** The conversion wraps it, not replaces it.
