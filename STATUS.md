# Bot Fleet — STATUS  ·  generated 2026-08-18
...
## Should-have-fired verdict — 2026-08-18
...
## Headline
- **Total closed P/L:** $4,327  ·  49 legs  ·  15 bots
  - Directional: $65  (SPX $65)
  - IC: $4,057  (QQQ $107  ·  SPX $3,950)
  - OA-Mirror: $205  (SPX $45)

## Champion — IC-SPX-FastPT25-S2
- P/L **$100**  ·  6 positions (0 condors, 6 single-sided) · 6 legs  ·  6 trading days (2 green / 0 red)
...
|---|---|---|--:|--:|--:|
| IC | IC-SPX-FastPT25-S2 | ON | 6 | $100 | 33% |
...
| IC | IC-SPX-FastPT25-S2-130PM | ON | 7 | $3,850 | 100% |
| OA-Mirror | 60min-ORB-10W-Paper-v1 | ON | 4 | $0 | 75% |
...
|---|---|---|--:|--:|--:|--:|:--|
| IC-SPX-FastPT25-S2 | IC | 0DTE | 6 | 10 | $4,900 | $4,900 | sized ✓ |
| IC-SPX-FastPT25-S2-130PM | IC | 0DTE | 7 | 10 | $4,750 | $4,800 | sized ✓ |
...
| 60min-ORB-10W-Paper-v1 | OA-Mirror | 0DTE | 4 | 1 | $910 | $920 | **1-lot — fill-untested** |
...
> **The productized loss autopsy.** Every real, settled (status=expired) leg replayed through the v1 hedge library — Ride/no-stop, PT+X%/SL-X% return-threshold rules, and an S2 strike-touch cut (tape-gated, 5-min grain). **Optimistic bound, not a live estimate** — every non-Ride arm assumes a fill exactly at the threshold; real fills slip. Compare rules by **R** (pnl÷risk), never $. Basis: PT/SL % are of the credit collected (`|premium|`), per `mfe_pct`/`mae_pct` already carrying that unit (verified against the ledger — see `scripts/hedge_tournament.py` docstring). **Defang: deferred v1** (15 legs marked, not modeled — needs an intraday premium-decay path not yet in the ledger).

| Rule | N | Exp(R) | Tot R | WR | maxDD-R | worst-R |
|---|--:|--:|--:|--:|--:|--:|
| ride | 15 | +5.8% | +0.86 | 100% | 0.00 | +4.2% |
| pt25 | 15 | +1.4% | +0.22 | 100% | 0.00 | +1.0% |
| pt50 | 15 | +2.9% | +0.43 | 100% | 0.00 | +2.1% |
| pt100 | 15 | +5.8% | +0.86 | 100% | 0.00 | +4.2% |
| sl50 | 15 | +2.0% | +0.29 | 53% | -0.08 | -3.2% |
| sl75 | 15 | +3.8% | +0.57 | 80% | -0.09 | -4.8% |
| sl100 | 15 | +4.2% | +0.63 | 87% | -0.06 | -6.4% |
| sl130 | 15 | +4.0% | +0.60 | 87% | -0.08 | -8.3% |
| s2 | 10 | +5.9% | +0.59 | 100% | 0.00 | +4.2% |

#### Per-bot cut  (Ride vs SL75 — the mid-spectrum published rung)
| Bot | N | Ride Exp(R) | SL75 Exp(R) | Δ |
|---|--:|--:|--:|--:|
| IC-SPX-FastPT25-S2-130PM | 14 | +5.8% | +3.7% | -2.1pp |
...
| 11-12 | n=8 · touch 0% · MAE -0.0% | — | n=1 · MAE -0.2% |
| 12-13 | n=3 · touch 50% · MAE -0.8% | — | n=1 · MAE -0.4% |
| 13-14 | n=16 · touch 0% · MAE -0.3% | n=9 · touch 0% · MAE -0.1% | — |
| 14-15 | — | — | n=2 · MAE -0.6% |
...
|---|---|---|---|---|--:|--:|--:|--:|:--:|
| 60min-ORB-10W-Paper-v1 | OA-Mirror | SPX | mirror-watch | ON | 4 | 4 | $0 | 75% | - |
...
| IC-SPX-FastPT25-S2 | IC | SPX | live-candidate | ON | 6 | 6 | $100 | 33% | - |
| Nigiri-Paper-v1 | OA-Mirror | — | mirror-watch | ON | 4 | 4 | $120 | 75% | - |
| IC-SPX-FastPT25-S2-130PM | IC | SPX | experiment | ON | 7 | 14 | $3,850 | 100% | - |
...
|---|---|---|:--:|--:|--:|---|
| IC-SPX-FastPT25-S2-130PM | experiment | CANDIDATE | ●○●●·· | 7 | +11.6% [+11.0, +12.1] | G2: 7 clean condors (need 20) |
...
| IC-SPX-FastPT25-S2 | live-candidate | VALIDATE | ●○○●·· | 6 | +0.3% [+0.0, +0.7] | G2: 6 clean condors (need 20) |
...
| 60min-ORB-10W-Paper-v1 | mirror-watch | ●○○●·· | 4 | +0.1% [-11.0, +5.9] | G2: 4 clean condors (need 20) |
...
| IC-SPX-FastPT25-S2-130PM | IC | 14 | +0.058 | +0.8 | $3,850 |
...
| IC-SPX-FastPT25-S2 | IC | 6 | +0.003 | +0.0 | $100 |
| 60min-ORB-10W-Paper-v1 | OA-Mirror | 4 | +0.001 | +0.0 | $0 |
...
| 60min-ORB-10W-Paper-v1 | OA-Mirror | 0 | 4 | 0 | insufficient data | insufficient data |
...
| IC-SPX-FastPT25-S2 | IC | 0 | 6 | 0 | insufficient data | insufficient data |
| IC-SPX-FastPT25-S2-130PM | IC | 7 | 0 | 7 | 1.00 | 2026-12-25 |
...
## Caveats
- **Positions:** 42 total (7 condors, 35 single-sided)  ·  49 legs.
...
- Single-sided positions (not condors): 35 positions.
